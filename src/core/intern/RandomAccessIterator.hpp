 ...
 *
 * The actual iterator should derive from this class publicly.
 * Additionally, it has to provide a const `iter_prop` method which returns a reference to the
 * internal property that corresponds to the current position.
 *
 ...
 */
template<typename Derived> class RandomAccessIterator {
 public:

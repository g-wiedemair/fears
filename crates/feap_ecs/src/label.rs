...
/// This trait is automatically implemented for any 'static' type that implements `Eq`
pub trait DynEq: Any {
...
/// This trait is automatically implemented for any 'static' type that implements `Hash`
